...
description = """
<p align="center">
  <h1 align="center"><ins>GeoVision</ins> 📸<br>Single-image Calibration with Geometric Optimization</h1>

</p>

## Getting Started
GeoVision accurately estimates the camera intrinsics and gravity direction from a single image by 
